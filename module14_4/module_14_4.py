...
inline_menu = InlineKeyboardMarkup(
    inline_keyboard=[
        [InlineKeyboardButton(text='Product1 - Vanilla', callback_data='product_buying')],
        [InlineKeyboardButton(text='Product2 - Strawberry', callback_data='product_buying')],
        [InlineKeyboardButton(text='Product3 - Chocolate', callback_data='product_buying')],
        [InlineKeyboardButton(text='Product4 - Tropic', callback_data='product_buying')]
    ]
)
